    ...
    <div className="mt-6 grid gap-3 sm:flex sm:flex-wrap">
      {canConfirm && visibleActions.includes("confirm") ? (
        <form action={action}>
          ...
          <button
            type="submit"
            className="w-full rounded-full border border-brand-200 bg-brand-50 px-4 py-2 text-sm font-semibold text-brand-700 sm:w-auto"
          >
            Confirmar
          </button>
        </form>
      ...
      {canCancel && visibleActions.includes("cancel") ? (
        <form action={action}>
          ...
          <button
            type="submit"
            className="w-full rounded-full border border-rose-200 bg-rose-50 px-4 py-2 text-sm font-semibold text-rose-700 sm:w-auto"
          >
            Cancelar
          </button>
        </form>
      ...
      {canNoShow && visibleActions.includes("no-show") ? (
        <form action={action}>
          ...
          <button
            type="submit"
            className="w-full rounded-full border border-slate-200 bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-700 sm:w-auto"
          >
            Marcar no-show
          </button>
        </form>
