      ...
      <div className="grid gap-16 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-muted sm:text-[1.18rem]">
            {brand.name} ayuda a negocios de servicios a recibir reservas, reducir
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <ButtonLink href="/producto" variant="secondary" className="min-w-[176px]">
              Ver cómo funciona
            </ButtonLink>
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-[36px] border border-white/85 bg-[linear-gradient(180deg,_rgba(255,255,255,0.96)_0%,_rgba(244,248,255,0.96)_100%)] p-4 shadow-float sm:p-5">
            <div className="rounded-[30px] border border-line/70 bg-white/96 p-5 shadow-soft sm:p-6">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm text-muted">
                    Reservas, recordatorios y espacios recuperados en un solo lugar
                  </p>
                </div>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-2 rounded-full border border-line/80 bg-surface-soft px-3 py-2 text-xs text-muted">
                ...
                <div className="surface-panel p-4">
                  ...
                  <div className="mt-4 space-y-3">
                    {heroAppointments.map((appointment) => (
                      <div
                        key={`${appointment.hour}-${appointment.title}`}
                ...
                <div className="surface-panel overflow-hidden p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted">Vista rápida del calendario</p>
                    </div>
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        ...
                        <p className="mt-2 text-base font-semibold text-ink">
                          Recordatorio para la reserva de las 15:00
                        </p>
                      </div>
